  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          boxShadow: [if (showElevation) BoxShadow(color: Theme.of(context).bottomNavigationBarTheme.backgroundColor!, blurRadius: 2)]),
...
class _ItemWidget extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      curve: curve,
      decoration: BoxDecoration(
        color: isSelected ? item.activeColor.withOpacity(0.2) : Theme.of(context).bottomNavigationBarTheme.backgroundColor,
